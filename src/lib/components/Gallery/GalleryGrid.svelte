...
<section id="gallery" class="flex bg-gray-900 flex-col gap-1 md:gap-2 p-2">
  <div class="text-center mt-5">
    <span
      class="inline-block bg-red-500 text-white px-4 py-1 text-xs font-semibold rounded-md shadow"
    >
      Featured
    </span>
  ...
  <!-- Mosaic Masonry Grid -->
  <div class="max-w-6xl sm:mx-6  md:mx-auto my-10 mx-6 grid grid-cols-3 gap-4">
      ...
      >
        ...
        <div
          class="absolute inset-0 flex items-center justify-center
            opacity-0 hover:opacity-60 transition-opacity duration-200
            pointer-events-none"
        >
          <span
            class="text-pink text-xs bg-gray-500 bg-opacity-40 px-3 py-1.5
